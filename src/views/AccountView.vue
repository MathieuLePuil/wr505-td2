...
const fetchUserDetails = async () => {
    const response = await axios.get(`http://127.0.0.1:8000/api/users?username=${username.value}`);
...
const updateUserDetails = async () => {
    ...
    await axios.patch(`http://127.0.0.1:8000/api/users/${userid.value}`, userToUpdate, { headers });
