    ...
    methods: {
        ...
        async updateCategory(categorie) {
            try {
                ...
                await axios.patch(`https://mmi21b12.sae105.ovh/api/categories/${categorie.id}`, categoryToUpdate, { headers });
        ...
        async deleteCategory(categorie) {
            try {
                ...
                const categoryResponse = await axios.get(`https://mmi21b12.sae105.ovh/api/categories/${categorie.id}`, { headers });
                ...
                await axios.delete(`https://mmi21b12.sae105.ovh/api/categories/${categorie.id}`, { headers });
